...
def generate_app_report(search_input,No_0f_app,No_of_review):
    featuresIdentified = {}
    ## Extrating App ID's
    ab = []
    n_apps = No_0f_apps
    for keyword in search_input:
        result = search(keyword,
                    ...
                    n_hits= n_apps # defaults to 30 (= Google's maximum)
                    )
    #print(result)
    ...
    app_reviews_df1 = pd.DataFrame(app_reviews)

    #app_reviews_df1.head()

    ### Identify duplicates records in the data
    duplicate = app_reviews_df1.duplicated()
    duplicate
    sum(duplicate)

    #No Duplicates in that dataset
    app_reviews_df = app_reviews_df1.drop_duplicates()
    #Data Preprocessing
    ...
    #plt.plot()
    plt.savefig(r'C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\installs.png')
    ...
    plt.savefig(r'C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\rd_vs_in.png')
    #plt.plot()
    ...
    plt.savefig(r'C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\add.png')
    #plt.plot()
    # # Text Pre-Processing 
    ...
    with open(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\stopwords_en.txt") as sw:
            stop_words2 = sw.read()
    ...
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\re_uni_wc.jpg")                             
    ...
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\re_bi_wc.jpg")
    #plt.figure(4)
    ...
    wordCloud.generate_from_frequencies(words_dict)
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\re_Tri_wc.jpg")
    #plt.figure(4)
    ...
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\info_uni_wc.jpg")
    #plt.imshow(wordcloud, interpolation='bilinear')
    #plt.title("Most frequently occurring unigrams connected by same colour and font size")
    #plt.axis("off")
    #plt.show()
    ...
    wordCloud.generate_from_frequencies(words_dict)
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\info_bi_wc.jpg")
    #plt.figure(4)
    #plt.title('Most frequently occurring bigrams connected by same colour and font size')
    #plt.imshow(wordCloud, interpolation='bilinear')
    #plt.axis("off")
    ...
    wordCloud.generate_from_frequencies(words_dict)
    wordcloud.to_file(r"C:\Users\madym\Downloads\360 digi\Project\New folder\Assist App Developer - AAD\static\img\info_Tri_wc.jpg")
    #plt.figure(4)
    #plt.title('Most frequently occurring Trigrams connected by same colour and font size')
    #plt.imshow(wordCloud, interpolation='bilinear')
    #plt.axis("off")
