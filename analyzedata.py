# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 11:52:29 2022
...
def generate_app_report(search_input,No_of_review):
    ## Extrating App ID's
    frames = [ ]
    ...
    app_infos_df1.to_csv(r'static\Dataset\apps.csv')
    app_reviews1.to_csv(r'static\Dataset\reviews.csv')
    ...
    #plt.plot()
    plt.savefig(r'static\img\installs.png')
    ...
    plt.savefig(r'static\img\rd_vs_in.png')
    #plt.plot()
    ...
    plt.savefig(r'static\img\add.png')
    #plt.plot()
    # # Text Pre-Processing 
    ...
    ap_reviews_join1 = " ".join(app_reviews1["text_lemmatized"])
    ...
    app_info1 = ap_info1_join + ap_info2_join

    #print(app_info)
    ap_reviews_join2 = re.sub("[^A-Za-z" "]+", " ",ap_reviews_join1).lower()
    ap_reviews_join = re.sub("[0-9" "]+"," ",ap_reviews_join2)
    
    app_info2 = re.sub("[^A-Za-z" "]+", " ",app_info1).lower()
    app_info = re.sub("[0-9" "]+"," ",app_info2)
    ...
    words_freq_lenu = len(words_frequ)
    if words_freq_lenu > 200:
        words_dict1 = dict(words_frequ[:200])
    else:
        words_dict1 = dict(words_frequ)
    ...
    WC_width1 = 1500
    WC_max_words1 = 200
    wordCloud1 = WordCloud(background_color = 'White', max_words=WC_max_words1, height=WC_height1, width=WC_width1)
        
    wordCloud1.generate_from_frequencies(words_dict1)
    wordCloud1.to_file(r"static\img\re_uni_wc.jpg")                            
    ...
    vectorizerq = TfidfVectorizer(ngram_range=(2, 2))
    bag_of_wordsq = vectorizerq.fit_transform(dict1)
    vectorizerq.vocabulary_

    sum_wordsq = bag_of_wordsq.sum(axis=0)
    words_freq = [(word, sum_wordsq[0, idx]) for word, idx in vectorizerq.vocabulary_.items()]
    words_freq = sorted(words_freq, key = lambda x: x[1], reverse=True)
    #print(words_freq[:100])
    # Generating wordcloud
    words_dict2 = dict(words_freq)
    WC_height2 = 1000
    WC_width2 = 1500
    WC_max_words2 = 100
    wordCloud2 = WordCloud(max_words=WC_max_words2, height=WC_height2, width=WC_width2,background_color ='white')

    wordCloud2.generate_from_frequencies(words_dict2)
    wordCloud2.to_file(r"static\img\re_bi_wc.jpg")
    #plt.figure(4)
    ...
    # Using count vectoriser to view the frequency of bigrams
    vectorizer1 = TfidfVectorizer(ngram_range=(3,3))
    ...
    # Generating wordcloud
    words_dict3 = dict(words_freq1)
    WC_height3 = 1000
    WC_width3 = 1500
    WC_max_words3 = 100
    wordCloud3 = WordCloud(max_words=WC_max_words3, height=WC_height3, width=WC_width3,background_color ='white')
    wordCloud3.generate_from_frequencies(words_dict3)
    wordCloud3.to_file(r"static\img\re_Tri_wc.jpg")
    #plt.figure(4)
    ...
    # Using count vectoriser to view the frequency of unigram
    vectorizerq1 = TfidfVectorizer(ngram_range=(1, 1))
    bag_of_wordsq1 = vectorizerq1.fit_transform(Final_infos)
    vectorizerq1.vocabulary_

    sum_wordsq1 = bag_of_wordsq1.sum(axis=0)
    words_freqq1 = [(word, sum_wordsq1[0, idx]) for word, idx in vectorizerq1.vocabulary_.items()]
    words_freqq1 = sorted(words_freqq1, key = lambda x: x[1], reverse=True)
    #print(words_freqq1[:100])
    WC_height_11 = 2500
    WC_width_11 = 3500
    WC_max_words_11 = 200
    words_dict = dict(words_freqq1)
    wordCloud_11 = WordCloud(background_color = 'White', max_words=WC_max_words_11, height=WC_height_11, width=WC_width_11)
        
    wordCloud_11.generate_from_frequencies(words_dict)
    wordCloud_11.to_file(r"static\img\info_uni_wc.jpg")
    #plt.imshow(wordcloud, interpolation='bilinear')
    #plt.title("Most frequently occurring unigrams connected by same colour and font size")
    #plt.axis("off")
    #plt.show()
    ...
    # Generating wordcloud
    words_dict12 = dict(words_freq_if)
    WC_height12 = 1000
    WC_width12 = 1500
    WC_max_words12 = 100

    wordCloud12 = WordCloud(max_words=WC_max_words12, height=WC_height12, width=WC_width12,background_color ='white')

    wordCloud12.generate_from_frequencies(words_dict12)
    wordCloud12.to_file(r"static\img\info_bi_wc.jpg")
    #plt.figure(4)
    #plt.title('Most frequently occurring bigrams connected by same colour and font size')
    #plt.imshow(wordCloud, interpolation='bilinear')
    #plt.axis("off")
    ...
    bag_of_words_if1 = vectorizer_if1.fit_transform(dict_if1)
    ...
    # Generating wordcloud
    words_dict13 = dict(words_freq_if1)
    WC_height13 = 1000
    WC_width13 = 1500
    WC_max_words13 = 100
    wordCloud13 = WordCloud(max_words=WC_max_words13, height=WC_height13, width=WC_width13,background_color ='white')

    wordCloud13.generate_from_frequencies(words_dict13)
    wordCloud13.to_file(r"static\img\info_Tri_wc.jpg")
    #plt.figure(4)
    #plt.title('Most frequently occurring Trigrams connected by same colour and font size')
    #plt.imshow(wordCloud, interpolation='bilinear')
    #plt.axis("off")
...
#keywords = "Online Learning app"
#print(keywords)
#keywordList = [ keyword.strip() for keyword in keywords.split(',')]
#print(keywordList)
#generate_app_report(keywordList, 2)
